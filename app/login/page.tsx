...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-brand-green/5 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-5xl bg-white rounded-[2rem] overflow-hidden shadow-2xl flex flex-col-reverse md:flex-row min-h-[600px] lg:min-h-[700px]">
        
        {/* Left Image Section */}
        <div className="w-full md:w-1/2 relative min-h-[300px] md:min-h-full bg-brand-light">
          <Image 
            src="https://images.unsplash.com/photo-1466692476877-361ad31a2334?q=80&w=800&auto=format&fit=crop" 
            alt="Vibrant tropical leaves" 
            fill 
          ...
          <div className="absolute bottom-8 left-8 right-8 z-10 hidden md:block">
             <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 shadow-xl">
                 <p className="text-white font-medium text-lg italic leading-snug">"A single dashboard to monitor everything. It's transformed how I manage my crops."</p>
                 <div className="flex items-center gap-3 mt-4">
                    <div className="w-10 h-10 bg-brand-orange rounded-full flex items-center justify-center text-white font-bold">S</div>
                    <div>
                      <p className="text-white text-sm font-bold">Sarah Jenkins</p>
                      <p className="text-white/70 text-xs">Wheat Producer</p>
                    </div>
                 </div>
             </div>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" className="flex items-center justify-center gap-2 w-full border border-neutral-200 hover:border-neutral-300 hover:bg-neutral-50 px-4 py-3 rounded-lg transition-all">
              ...
              <span className="text-xs font-bold text-neutral-700">Log in with Google</span>
            </button>
            <button type="button" className="flex items-center justify-center gap-2 w-full bg-neutral-900 border border-neutral-900 hover:bg-neutral-800 text-white px-4 py-3 rounded-lg transition-all">
              ...
              <span className="text-xs font-bold text-white">Log in with Apple</span>
            </button>
          </div>
